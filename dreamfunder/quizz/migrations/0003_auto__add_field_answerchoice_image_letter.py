...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswerChoice.image_letter'
        db.add_column('quizz_answerchoice', 'image_letter',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnswerChoice.image_letter'
        db.delete_column('quizz_answerchoice', 'image_letter')
