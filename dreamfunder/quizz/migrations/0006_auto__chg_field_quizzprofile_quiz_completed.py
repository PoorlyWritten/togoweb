...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuizzProfile.quiz_completed'
        db.alter_column('quizz_quizzprofile', 'quiz_completed', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'QuizzProfile.quiz_completed'
        raise RuntimeError("Cannot reverse this migration. 'QuizzProfile.quiz_completed' and its values cannot be restored.")
    ...
    models = {
        ...
        'quizz.quizzprofile': {
            ...
            'quiz_completed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
