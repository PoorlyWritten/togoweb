...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizzProfile.quiz_answers'
        db.add_column('quizz_quizzprofile', 'quiz_answers',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)

        # Adding field 'QuizzProfile.quiz_relationship'
        db.add_column('quizz_quizzprofile', 'quiz_relationship',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuizzProfile.quiz_event'
        db.add_column('quizz_quizzprofile', 'quiz_event',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'QuizzProfile.quiz_answers'
        db.delete_column('quizz_quizzprofile', 'quiz_answers')

        # Deleting field 'QuizzProfile.quiz_relationship'
        db.delete_column('quizz_quizzprofile', 'quiz_relationship')

        # Deleting field 'QuizzProfile.quiz_event'
        db.delete_column('quizz_quizzprofile', 'quiz_event')
